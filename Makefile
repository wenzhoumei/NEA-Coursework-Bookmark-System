...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		include/title_controller.hpp src/log.cpp \
		src/main.cpp \
		src/menu_tui.cpp \
		src/option_list.cpp \
		src/parser.cpp
