#############################################################################
# Makefile for building: files/program.program
...
CXXFLAGS      = -pipe -std=c++20 -I/usr/local/include -O2 -flto -fno-fat-lto-objects -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
DISTDIR = /home/wenzhou/Entries/.tmp/program.program1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -std=c++20 -I/usr/local/include -O2 -flto=8 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
LIBS          = $(SUBLIBS) -L./libs -lftxui-component -lftxui-dom -lftxui-screen /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = gcc-ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
all: Makefile files/program.program
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++20 -I/usr/local/include -O2 -flto -fno-fat-lto-objects -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
...
main.o: main.cpp ftxui/component/captured_mouse.hpp \
